...
if(isfile('F:\Vehicle Developement Data\PerformanceMetric.csv'))
    delete('F:\Vehicle Developement Data\PerformanceMetric.csv');
end
if(isfile('F:\Vehicle Developement Data\Vehicle Matlab Output_Range City.csv'))
    delete('F:\Vehicle Developement Data\Vehicle Matlab Output_Range City.csv');
end
if(isfile('F:\Vehicle Developement Data\Vehicle Matlab Output_Range Hwy.csv'))
    delete('F:\Vehicle Developement Data\Vehicle Matlab Output_Range Hwy.csv');
end
if(isfile('F:\Vehicle Developement Data\Vehicle Matlab Output_Top Speed x Grade.csv'))
    delete('F:\Vehicle Developement Data\Vehicle Matlab Output_Top Speed x Grade.csv');
end
if(isfile('F:\Vehicle Developement Data\Vehicle Matlab Output_Wide Open Throtle.csv'))
    delete('F:\Vehicle Developement Data\Vehicle Matlab Output_Wide Open Throtle.csv');
end
...
fid = fopen('C:\EV Academy\EVSim\EV_4\EV_4\EV\Vehicle Matlab Input .txt');%Vehicle Matlab Input 23.18427.txt');
...
for i =1:1:size(DriveSchedule,1)
    if (DriveSchedule(i,1)=='Range (km) - City')
        ...
        writetable(T,'F:\Vehicle Developement Data\Vehicle Matlab Output_Range City.csv');
    ...
    elseif(DriveSchedule(i,1)=='Top Speed (kph) x% grade')
        ...
        writetable(T,'F:\Vehicle Developement Data\Vehicle Matlab Output_Top Speed x Grade.csv');
    ...
    elseif(DriveSchedule(i,1)=='Range (km) - Hwy (or Mwy)')
        ...
        writetable(T,'F:\Vehicle Developement Data\Vehicle Matlab Output_Range Hwy.csv');
    ...
    elseif(DriveSchedule(i,1)=='Time (sec) 50 - 80 kph' || DriveSchedule(i,1)=='Top Speed (kph) 0% grade' || DriveSchedule(i,1)=='Time (sec) 0 - 100 kph' || DriveSchedule(i,1)=='Time (sec) 0.4 km')% || DriveSchedule(i,1)=='Time (sec) 50 - 80 kph')
        ...
        if (sim1 == 1)
            ...
            writetable(T,'F:\Vehicle Developement Data\Vehicle Matlab Output_Wide Open Throtle.csv');
            T1(1,9) = [ANS2(end,2)];
        end
...
writetable(T3,'F:\Vehicle Developement Data\PerformanceMetric.csv');
end